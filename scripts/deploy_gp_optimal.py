...
from lib.optuna_common import DEFAULT_BASE_CONFIG, DEFAULT_SQLITE_DB, latest_study_name, next_version_path  # noqa: E402
...
def main():
    ...
    out_path = args.out or next_version_path(ROOT / "configs" / "gp", "ftr_config_gp_optimal")
